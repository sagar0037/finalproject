...
$checkUser = "SELECT * FROM staff WHERE username = '$username'";
...
elseif(mysqli_num_rows($instituteQuery)>0){
    $insertQuery = "INSERT INTO staff(full_name,username,email,password,phone,institute_id) VALUES('$full_name','$username','$email','$password','$phone','$institute_id')";
