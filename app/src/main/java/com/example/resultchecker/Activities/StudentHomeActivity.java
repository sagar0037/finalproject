...
import com.example.resultchecker.StudentFragments.StudentHomeFragment;
import com.example.resultchecker.StudentFragments.StudentProfileFragment;
        ...
        builder.setMessage("Do you really want to logout?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        progressDialog.show();
                        SharedPrefManager.setStringPreference(getApplicationContext(), Constants.STUDENT_ID, null);
                        ...
                        Intent intent=new Intent(StudentHomeActivity.this, SplashActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        progressDialog.dismiss();
                        Toast.makeText(StudentHomeActivity.this, "You have been logged out", Toast.LENGTH_SHORT).show();
                    }
                })
